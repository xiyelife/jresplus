...
/**
 * @author LeoHu copy by sagahl copy by alibaba
 */
public class ServerCookie {
	...
	private static final String ancientDate = OLD_COOKIE_FORMAT.get().format(
			new Date(10000));
	...
	public static boolean isToken2(String value, String literals) {
		String tspecials2 = literals == null ? ServerCookie.tspecials2
				: literals;
		if (value == null) {
			return true;
		}
	...
	public static void appendCookieValue(StringBuilder buf, int version,
		...
		if (path != null) {
			...
			if (version == 0) {
				...
				maybeQuote2(version, buf, path, ServerCookie.tspecials2NoSlash,
						false);
			}
		}
